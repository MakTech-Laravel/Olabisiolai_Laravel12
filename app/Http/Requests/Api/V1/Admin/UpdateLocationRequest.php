...
class UpdateLocationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'location.country_name' => ['nullable', 'string', 'max:120'],
            'location.country_iso_code' => ['nullable', 'string', 'max:10'],
            'location.country_is_active' => ['nullable', 'boolean'],
            'location.country_sort_order' => ['nullable', 'integer', 'min:0'],
            'location.state_name' => ['nullable', 'string', 'max:120'],
            'location.state_slug' => ['nullable', 'string', 'max:140'],
            'location.city_name' => ['nullable', 'string', 'max:120'],
            'location.lga_name' => ['nullable', 'string', 'max:120'],
            'location.lga_slug' => ['nullable', 'string', 'max:140', 'unique:locations,lga_slug,' . $this->input('id')],
            'location.vendor_count' => ['nullable', 'integer', 'min:0'],
            ...
            'boost_config.enabled' => ['nullable', 'boolean'],
